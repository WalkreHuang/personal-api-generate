...
class ApiMakeCommand extends Command
{
    ...
    protected function prepareVariablesForStubs($name)
    {
        ...
        $baseDir = config('api-model-generator.models_base_dir');
    ...
    {
        $entityNamespace = $this->convertSlashes(config("api-model-generator.{$entity}s_dir"));
    ...
    /**
     *  Create service class file from a stub.
     */
    protected function createService()
    {
        $this->createClass('service');
    }
    ...
    {
        $stub = $this->constructStub(base_path(config('api-model-generator.route_stub')));

        $routesFile = app_path(config('api-model-generator.routes_file'));
    ...
    protected function createClass($type)
    {
        ...
        $this->files->put($path, $this->constructStub(base_path(config('api-model-generator.'.$type.'_stub'))));
